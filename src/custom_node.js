...
customNode.prototype.normalizeRequestJSON = function (data) {
...
customNode.prototype.request = function (url, data) {
    return request.post(url, {
        json: this.normalizeRequestJSON(data),
...
customNode.prototype.getTransactionCount = function(addr, callback) {
    this.post({
...
customNode.prototype.rawPost = function(data, callback) {
    this.request(this.SERVERURL, data, this.config).then(function(data) {
        callback(data);
    }, function(data) {
...
module.exports = new customNode('https://etc-geth.0xinfra.com');
